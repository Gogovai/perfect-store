    ...
    <div className="py-6 sm:py-8 bg-gray-50 min-h-[calc(100vh-8rem)]">
      <Container size="lg">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <Badge variant={getStatusBadgeVariant(order.status)} className="self-start sm:self-auto">
        ...
        <div className={`p-4 rounded-xl mb-6 ${
          ...
          {order.status === 'pending' && (
            <p className="text-xs text-red-600 mt-1">
              Payment processing will be available soon. Your order is currently pending confirmation.
            </p>
          )}
        </div>
                        ...
                        <div key={step.status} className="flex gap-3">
                          <div className="flex flex-col items-center">
                            ...
                            {!isLast && (
                              <div
                                className={`w-0.5 h-8 ${
                                  index < currentStepIndex ? 'bg-[#0f2b5b]' : 'bg-gray-200'
                                }`}
                              />
                            )}
                          </div>
            ...
            <Card>
              <CardContent className="p-5">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span>Delivery</span>
                    <span className={`font-medium ${order.shipping_cost === 0 ? 'text-green-600' : 'text-gray-900'}`}>
              ...
              <CardContent className="p-5">
                ...
                <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <p className="text-sm font-medium text-amber-800">
                    {order.payment?.status === 'pending' ? 'Payment: Pending' : order.payment?.status || 'Pending'}
                  </p>
