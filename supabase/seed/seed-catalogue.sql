...
BEGIN
  ...
  SELECT * FROM (VALUES
    ('TechHub Ghana', 'techhub-ghana', v_owner, 'Trusted electronics and gadgets in Accra.', 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233501234567', 'contact@techhub.com'),
    ('Fashion Avenue', 'fashion-avenue', v_owner, 'Trendy fashion for men and women.', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233502345678', 'contact@fashionave.com'),
    ('Home Essentials', 'home-essentials', v_owner, 'Quality home and kitchen products.', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233503456789', 'contact@homeess.com'),
    ('Beauty Palace', 'beauty-palace', v_owner, 'Premium beauty and skincare products.', 'https://images.unsplash.com/photo-1596464716127-f2a82984de30?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233504567890', 'contact@beautypalace.com'),
    ('Gadget World', 'gadget-world', v_owner, 'Latest gadgets and tech accessories.', 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233505678901', 'contact@gadgetworld.com'),
    ('Accra Market', 'accra-market', v_owner, 'One-stop shop for everyday essentials.', 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233506789012', 'contact@accramarket.com'),
    ('Kumasi Fashion House', 'kumasi-fashion', v_owner, 'Authentic Ghanaian fashion from Kumasi.', 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233507890123', 'contact@kumasifashion.com'),
    ('FitZone Sports', 'fitzone-sports', v_owner, 'Sports equipment and fitness gear.', 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=200&h=200&fit=crop&q=80', 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&h=200&fit=crop&q=80', 'active'::text, 0.1, '+233508901234', 'contact@fitzone.com')
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'samsung-galaxy-a15') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?w=800&h=800&fit=crop&q=80', 'Samsung Galaxy A15', 0, true), (v_prod, 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?w=800&h=800&fit=crop&q=80', 'Samsung Galaxy A15 back', 1, false);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'iphone-14-128gb') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1592899677977-9c10ca588bbd?w=800&h=800&fit=crop&q=80', 'iPhone 14', 0, true), (v_prod, 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?w=800&h=800&fit=crop&q=80', 'iPhone 14 back', 1, false);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'tecno-spark-20-pro') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800&h=800&fit=crop&q=80', 'Tecno Spark 20 Pro', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'infinix-hot-40-pro') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800&h=800&fit=crop&q=80', 'Infinix Hot 40 Pro', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'hp-laptop-15s') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=800&h=800&fit=crop&q=80', 'HP Laptop 15s', 0, true), (v_prod, 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=800&h=800&fit=crop&q=80', 'HP Laptop keyboard', 1, false);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'lenovo-ideapad-slim') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=800&h=800&fit=crop&q=80', 'Lenovo IdeaPad Slim 3', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'dell-inspiron-15') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=800&h=800&fit=crop&q=80', 'Dell Inspiron 15', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'logitech-mk270') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=800&h=800&fit=crop&q=80', 'Logitech MK270', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'canon-pixma-g3420') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=800&h=800&fit=crop&q=80', 'Canon PIXMA G3420', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'jbl-tune-520bt') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=800&h=800&fit=crop&q=80', 'JBL Tune 520BT', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'samsung-galaxy-buds-fe') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=800&h=800&fit=crop&q=80', 'Samsung Galaxy Buds FE', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'anker-soundcore-2') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800&h=800&fit=crop&q=80', 'Anker Soundcore 2', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'jbl-clip-4') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800&h=800&fit=crop&q=80', 'JBL Clip 4', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mens-classic-polo') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=800&fit=crop&q=80', 'Mens Polo Shirt', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mens-chino-trousers') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&h=800&fit=crop&q=80', 'Mens Chinos', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mens-denim-jacket') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&h=800&fit=crop&q=80', 'Mens Denim Jacket', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 60, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mens-running-sneakers') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=800&fit=crop&q=80', 'Mens Sneakers', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'womens-ankara-dress') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&h=800&fit=crop&q=80', 'Womens Ankara Dress', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 45, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'womens-casual-blouse') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=800&h=800&fit=crop&q=80', 'Womens Blouse', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'womens-palazzo-pants') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&h=800&fit=crop&q=80', 'Palazzo Pants', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'womens-platform-sandals') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=800&h=800&fit=crop&q=80', 'Womens Sandals', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 70, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'mens-leather-wallet') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=800&h=800&fit=crop&q=80', 'Leather Wallet', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'womens-crossbody-bag') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&h=800&fit=crop&q=80', 'Crossbody Bag', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'unisex-sports-watch') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800&h=800&fit=crop&q=80', 'Digital Sports Watch', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'aviator-sunglasses') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=800&h=800&fit=crop&q=80', 'Aviator Sunglasses', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 150, 0, 10);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'nonstick-cookware-set') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&h=800&fit=crop&q=80', 'Cookware Set', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'moulinex-blender') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=800&h=800&fit=crop&q=80', 'Moulinex Blender', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 35, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'electric-kettle-2l') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&h=800&fit=crop&q=80', 'Electric Kettle', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 60, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'insulated-food-flask') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=800&h=800&fit=crop&q=80', 'Food Flask', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 100, 0, 10);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'ergonomic-office-chair') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=800&h=800&fit=crop&q=80', 'Office Chair', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'standing-desk') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=800&h=800&fit=crop&q=80', 'Standing Desk', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'shea-moisture-shea-butter') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=800&h=800&fit=crop&q=80', 'Shea Butter', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'vitamin-c-serum') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=800&h=800&fit=crop&q=80', 'Vitamin C Serum', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 150, 0, 10);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'kids-sunscreen-spf50') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=800&h=800&fit=crop&q=80', 'Kids Sunscreen', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'moroccanoil-treatment') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=800&h=800&fit=crop&q=80', 'Moroccanoil', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 60, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'multivitamin-tablets') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800&h=800&fit=crop&q=80', 'Multivitamin', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 200, 0, 20);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'digital-bp-monitor') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&h=800&fit=crop&q=80', 'BP Monitor', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 40, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'resistance-bands-set') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800&h=800&fit=crop&q=80', 'Resistance Bands', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'adjustable-dumbbells') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&h=800&fit=crop&q=80', 'Dumbbells', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 20, 0, 3);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'yoga-mat-6mm') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=800&h=800&fit=crop&q=80', 'Yoga Mat', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 100, 0, 10);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'football-size5') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800&h=800&fit=crop&q=80', 'Football', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 80, 0, 10);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'basmati-rice-5kg') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=800&h=800&fit=crop&q=80', 'Basmati Rice', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'organic-honey-500ml') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=800&h=800&fit=crop&q=80', 'Raw Honey', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 150, 0, 15);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'instant-coffee-200g') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefda?w=800&h=800&fit=crop&q=80', 'Instant Coffee', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'coconut-oil-1l') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=800&h=800&fit=crop&q=80', 'Coconut Oil', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 200, 0, 20);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'baby-stroller-2in1') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800&h=800&fit=crop&q=80', 'Baby Stroller', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 20, 0, 3);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'lego-classic-484') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=800&h=800&fit=crop&q=80', 'LEGO Classic', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 40, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'kids-waterproof-jacket') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?w=800&h=800&fit=crop&q=80', 'Kids Jacket', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 60, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'car-vacuum-12v') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=800&h=800&fit=crop&q=80', 'Car Vacuum', 0, true);
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'dash-cam-1080p') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=800&h=800&fit=crop&q=80', 'Dash Cam', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 45, 0, 5);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM products WHERE slug = 'tyre-pressure-gauge') THEN
    ...
    INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES (v_prod, 'https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=800&h=800&fit=crop&q=80', 'Tyre Gauge', 0, true);
    INSERT INTO inventory (product_id, quantity, reserved_quantity, low_stock_threshold) VALUES (v_prod, 200, 0, 20);
  END IF;
